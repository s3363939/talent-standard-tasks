...
export default class ResetPassword extends React.Component {
    ...
    checkToken(email, token) {
        ...
        let url = `https://talentservicesidentity20200318051529.azurewebsites.net/authentication/authentication/verifyResetPasswordToken?o=${email}&p=${token}`;
        $.ajax({
            url: url,
            type: 'POST',
    ...
    savePassword() {
        ...
        let resetUrl = `https://talentservicesidentity20200318051529.azurewebsites.net/authentication/authentication/resetpassword?o=${email}&p=${token}`;
